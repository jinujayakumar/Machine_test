...
class Creators : Parcelable {
    ...
    companion object {
        @JvmField
        val CREATOR: Parcelable.Creator<Creators> = object : Parcelable.Creator<Creators> {
            override fun createFromParcel(source: Parcel): Creators {
                return Creators(source)
            }

            override fun newArray(size: Int): Array<Creators?> {
